  ...
  return (
    <div className="bg-background">
      ...
      <main className="container mx-auto px-5 lg:max-w-screen-md">
        <div>
          <h1 className="text-4xl font-Alegreya font-bold text-title">{projectsData.id}</h1>
        </div>
        <div className=" mt-6 text-justify font-Roboto  text-gray-600" dangerouslySetInnerHTML={{ __html: projectsData.contentHtml }} />
      </main>
      <footer>
        <Footer/>
      </footer>
